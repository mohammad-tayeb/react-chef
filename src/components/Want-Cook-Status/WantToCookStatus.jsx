...
const WantToCookStatus = ({ foodItem, handleCurentlyCooking, handleCurentlyCookingFood }) => {
    ...
    return (
        <div className='flex mt-8'>
            ...
            <button onClick={() => {handleCurentlyCooking(food_name, time, calorie); handleCurentlyCookingFood(foodItem)}} className="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-2 rounded">
                Prepeare
            </button>
        </div>
    );
